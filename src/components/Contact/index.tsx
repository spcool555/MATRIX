...
const Contact = () => {
  return (<>
    ...
    <div
      className="w-full bg-[#F9A605]   flex flex-col lg:flex-row  items-center  py-6 sm:py-9 md:py-11 lg:py-14  px-2  sm:px-4 md:px-8 xl:px-16">
      <img className="w-full lg:w-1/2 xl:w-full max-w-[400px] lg:order-2" src="https://iili.io/2ysFUen.png" alt=""/>
      <div className="text-center md:text-left">
        <h1
          className="text-4xl leading-[48px] md:text-5xl md:leading-[58px] lg:text-[50px] lg:leading-[70px] font-bold mb-6 md:mb-5">
      ...
      <div className="lg:pr-16">
        <div className="flex flex-wrap bg-white">
          ...
          <div className="w-full lg:w-4/12 xl:w-4/12  border-l-2 border-gray-500">
            <NewsLatterBox2 />
          </div>
          <div className="w-full lg:w-4/12 xl:w-4/12  border-l-2 border-gray-500">
            <NewsLatterBox />
