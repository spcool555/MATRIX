...
const NewsLatterBox2 = () => {
  const { theme } = useTheme();

  return (
    <div className="relative z-10 rounded-sm bg-white p-5 shadow-three dark:bg-gray-dark sm:p-11 lg:p-5 xl:p-5 ">
      ...
      <div>
        <ul className="list-inside list-disc">
          <li className="mb-2">
            <a href="#" className="text-black hover:text-[#f9b800] hover:underline">
              Earthing / Grounding
            </a>
          </li>
          <li className="mb-2">
