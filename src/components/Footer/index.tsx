...
const Footer = () => {
 ...
 <footer className="bg-black text-center text-white dark:bg-black dark:text-neutral-200 lg:text-left" style={{ borderTop: "2px solid #F7BE38" }}>
  {/* Main container div */}
  <div className="mx-36 py-10 text-center md:text-left">
    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
      {/* TW Elements section */}
      <div>
        <img src="/images/logo/logo22.png" alt="Logo" style={{ width: "80%" }} />
      ...
      <div >
        ...
        <p className="mb-4">
          <a className="text-white hover:text-[#fff350]">Technical Service</a>
        </p>
        <p className="mb-4">
          <a className="text-white hover:text-[#fff350]">About Us</a>
        </p>
        <p className="mb-4">
          <a className="text-white hover:text-[#fff350]">Certification</a>
        </p>
