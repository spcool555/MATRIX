...
const Features = () => {
  ...
  return (
    <>
      ...
      <section className=" w-full  bg-black px-8 py-16">
      {/* <!-- Content --> */}
  <div className="relative z-10 container mx-auto px-4 text-center text-white">
    <h1 className="mb-6 text-xl font-bold tracking-tight sm:text-2xl md:text-6xl lg:text-4xl">
    Our Products <span className="relative whitespace-nowrap text-[#F7A906] dark:text-[#F7A906]">        <span className="relative">Range</span>
      </span>
    </h1>
  ...
  <div className="container text-black">
          ...
          {/* <div className="btn my-10">
            <center>
                <button className="bg-[#F9A605] text-white px-6 py-3 rounded-lg animate-pulse hover:animate-none shadow-lg hover:shadow-[#F9A605]/50 transition duration-300">
                View All Products
                </button>
