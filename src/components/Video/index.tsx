...
const Video = () => {
  ...
  return (
    ...
    <div className="relative z-10 flex flex-col justify-center items-center h-full text-center pt-12">
      <h1 className="text-5xl leading-tight my-4 text-white">10+ Years Of Trust</h1>
      <p className="w-3/5 text-lg text-white mb-8">With over 10 years of trusted expertise, we specialize in the production of high-quality electrical equipment, ensuring reliability, innovation, and industry-leading standards.</p>
    </div>
    ...
    <div className="w-fit mx-auto grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2 gap-12 my-16">
        <div
            className="group w-64 h-96 bg-white dark:bg-[#f9b800] shadow-md relative rounded-lg m-4 hover:ring hover:ring-[#f9b800] dark:hover:ring-white transform duration-500 hover:scale-105 hover:shadow-xl">
            <div
