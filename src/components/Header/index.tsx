...
const Header = () => {
  ...
  return (
    <>
      ...
      > */}
      <header
        className={`header top-15 left-0 z-40 flex w-full items-center absolute bg-[#FBB73F]`}
      >
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg  ring-white focus:ring-2 lg:hidden"
                >
                  <span
                ...
                >
                  ...
                  <ul className="block items-center justify-center bg-transparent align-middle lg:flex -mb-7">
                        ...
                        {menuItem.path ? (
                          ...
                          <>
                            ...
                            <div
                              ...
                              className={`mega-menu lg:-ml-52 mt-1  relative left-0 top-full rounded-sm bg-white transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[1000px]  lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${
                                        ...
                                        <ul>
                                          ...
                                          {submenuCategory.title}
                                                ...
                                                <Link
                                                  ...
                                                  className="block lg:py-0.5 text-dark hover:text-blue-600 dark:text-white/70 dark:hover:text-white"
                                                >
                                                  {submenuItem.title}
                                                </Link>
                                              </li>
