...
const blogData: Blog[] = [
  {
    ...
    paragraph:
      "At Matrixincorporation, to complement our highly successful material supply business, we also offer a complete Electrical Earthing Design Service using CDEGS software.",
  ...
  {
    id: 3,
    title: "Protect EV Charging Station",
    paragraph:
