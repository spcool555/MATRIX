...
const AboutSectionOne = () => {
  ...
  return (<>
    <section id="about" className="py-16 md:pt-20 lg:pt-28">
      <div className="container">
      <main className="relative font-inter antialiased">
       <center> 
       <h1 className="mb-10 text-4xl font-bold leading-none tracking-tight text-blue-950 md:text-4xl lg:text-4xl dark:text-[#22295C]">OUR CLIENTS</h1>
       </center>
