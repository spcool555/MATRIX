...
<section className="bg-blue-50 dark:bg-slate-800" id="contact">
    ...
    <div className="flex items-stretch justify-center">
      <div className="grid md:grid-cols-2">
        <div className="h-full pr-6">
         ...
         <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d59533.963915517415!2d79.06749526616059!3d21.15746200235821!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sgoogle%20map!5e0!3m2!1sen!2sin!4v1719598586935!5m2!1sen!2sin" width={600} height={450} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
   </div>
  ...
  <form id="contactForm">
    <div className="mb-6">
      ...
      <div className="mx-0 mb-1 sm:mb-4">
        <label htmlFor="dropdown" className="pb-1 text-xs uppercase tracking-wider">Select an option</label>
        <select id="dropdown" name="dropdown" className="mb-2 w-full rounded-md border border-gray-400 py-2 pl-2 pr-4 shadow-md dark:text-gray-300 sm:mb-0">
          ...
          <option value="option3">Earthing Design Service</option>
          <option value="option3">Ligthning Protection Design Services</option>
          <option value="option3">Instalation Services</option>
        </select>
      </div>
      <div className="mx-0 mb-1 sm:mb-4">
