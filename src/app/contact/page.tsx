                  ...
                  <li className="flex">
                    ...
                    <div className="mb-4 ml-4">
                      ...
                      <p className="text-gray-600 dark:text-slate-400">
                        #4-3-2/3/A Janta weight bridge Chincholi Road, Tandur
                       
                      </p>
                      <p className="text-gray-600 dark:text-slate-400">
                      (V) Tandur (M)  Telangana State India
                      </p>
                    </div>
                  </li>
                  <li className="flex">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="mx-0 mb-1 sm:mb-4">
                      ...
                      >
                        ...
                        <option value="option3">Earthing Design Service</option>
                        <option value="option3">
                          Ligthning Protection Design Services
                        </option>
                      ...
                      <div className="flex flex-col">
                        ...
                        <label className="mb-1">
                          <input
                            type="checkbox"
                            name="checkboxOption"
                            value="lightningProtectionProducts"
                            className="mr-2"
                          />
                        ...
                        <label className="mb-1">
                          <input
                            type="checkbox"
                            name="checkboxOption"
                            value="exothermicWeldingProducts"
                            className="mr-2"
                          />
                        ...
                        <label className="mb-1">
                          <input
                            type="checkbox"
                            name="checkboxOption"
                            value="lightningProtectionDesignServices"
                            className="mr-2"
                          />
